...
export function AreaPageHero({
  ...
  const waText = encodeURIComponent(
    `السلام عليكم، أريد طلب كشف تسربات في حي ${nameAr}`,
  );

  return (
    <section className="relative mb-10 overflow-hidden rounded-2xl shadow-soft-lg sm:mb-12 sm:rounded-3xl">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-primary/95 via-primary/75 to-primary/30 sm:via-primary/70" />
        <div
      ...
      <div className="relative z-10 flex min-h-[min(72vw,320px)] w-full flex-col items-start justify-end p-4 text-right text-on-primary sm:min-h-[380px] sm:p-6 md:min-h-[420px] md:p-10 lg:p-12">
